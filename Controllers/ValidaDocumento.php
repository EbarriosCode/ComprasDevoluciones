<?php 
	...
	// en caso de una devolucion producto por producto
	if(isset($_GET['NoDocumento']))
	{
	...
	// en caso de una devolucion dinero por producto se añade el campo de dinero a devolver
	if(isset($_GET['Documento']))
	{
		$inst = new Devoluciones();
		$factura = $_GET['Documento'];
						...
						echo "<div class='form-group'>						
			                  ...
			                  <div class='form-group'>
			                   ...
			                   <div class='form-group'>
			                    ...
			                    <div class='form-group'>
			                        <label class='control-label col-md-3 col-sm-3 col-xs-12'>Total en Efectivo a Devolver</label>
			                        <div class='col-md-6 col-sm-6 col-xs-12'>
			                          <input class='form-control col-md-7 col-xs-12' type='number' disabled value='".$item['costoTotal']."'>
			                        </div>
			                      </div>";
						echo "<script>";
								echo "$('#alerta').hide();";
