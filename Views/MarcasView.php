  ...
  <div class="right_col" role="main">
      <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <a href="MarcaNuevaController.php" class="btn btn-round btn-info"><i class="fa fa-plus"></i></a>
                ...
                <table class="table table-hover">
                  ...
                  <?php foreach($Marcas as $item): ?>
                   <tr>
                     ...
                     <td class="text-right"><button type="button" class="btn btn-round btn-success" data-toggle='modal' data-target='#modal-editar' onclick="CargarDatos('<?php echo $item['idMarca'];?>','<?php echo $item['nombreMarca'];?>');"><i class="fa fa-edit"></i> Editar</button>
                     </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h2 class="text-center "><strong>Editar Marca <span class="fa fa-pencil"></span></strong></h2>
            </div>
            ...
            <div class="form-group">                                            
               ...
               <input type="text" id="marca" name="marca" class="form-control" required autofocus>
            </div> 

            

            <div class="modal-footer">
                    <input type="submit" class="btn btn-success" id="editar-marcas" name="editar-marcas"  value="Actualizar">
